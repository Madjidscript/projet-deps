$(document).ready(function () {
        ...
        if (file) {
            ...
            reader.onload = function (e) {
                ...
                rows.forEach((row, index) => {
                    ...
                    if (columns.length === 14) { // Vérifie que les colonnes sont valides
                        table.row.add([
    ...
    $('#downloadBtn').on('click', function () {
        let csv = 'N°,matricule,Nom et Prenom,sexe(1),pays(3) ,Diplôme,Grade (4),Statut (5) ,Spécialité,Date 1ère prise de service,formation continue(6),heures de cour prevue/an,heure de cour realisé/an';
