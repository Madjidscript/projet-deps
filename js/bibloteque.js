$(document).ready(function () {
    ...
    $('#downloadBtn').on('click', function () {
        let csv = 'N°,Capacité d’accueil (1),Nombre de Cartes de lecteurs Internes, Nombre de Cartes de lecteurs Externes ,Nombre de Micro ordinateurs connectés à Internet,Nom du logiciel de gestion de la bibliothèque ';
